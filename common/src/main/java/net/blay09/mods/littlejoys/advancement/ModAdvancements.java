...
public class ModAdvancements {
    ...
    public static final ResourceLocation root = id("littlejoys/root");
    public static final ResourceLocation digSpot = id("littlejoys/dig_spot");
    public static final ResourceLocation fishingSpot = id("littlejoys/fishing_spot");
    public static final ResourceLocation dropRushComplete = id("littlejoys/drop_rush_complete");
    public static final ResourceLocation goldRush = id("littlejoys/gold_rush");
    ...
    private static void awardRootAnd(ServerPlayer player, ResourceLocation id) {
        award(player, root);
        award(player, id);
    }
