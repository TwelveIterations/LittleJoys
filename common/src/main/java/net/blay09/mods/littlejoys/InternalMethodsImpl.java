...
public class InternalMethodsImpl implements InternalMethods {
    @Override
    public <T extends EventCondition> void registerEventCondition(Identifier identifier, Class<T> clazz, MapCodec<T> codec, Function<RegistryFriendlyByteBuf, T> networkDeserializer) {
